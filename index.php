...
$arr = array(
	...
	/*
	'http://www.proininews.gr/feed/','feed://www.trikaladay.gr/rss.aspx?UICulture=el-GR&category=8',
    ...
    'feed://www.karditsanews.gr/feed/',
    'feed://www.karditsaportal.gr/rss.xml'
    */
);
...
function getFeed($url)
{
    ...
    //Suppress errors since some feeds don't provide image link.
    ...
    //TODO add custom image link if source's image is not found
         $img_link="NULL";
    }
...
{
	$coords=array();
	$fullurl = "https://maps.googleapis.com/maps/api/geocode/json?address=".$city."&key=AIzaSyAd88b56kVh6zTmu1aJEVrhn457hq8Mv3Q";
...
function shortURL($url)
{
    ...
    $ch = curl_init('https://www.googleapis.com/urlshortener/v1/url?key=AIzaSyAd88b56kVh6zTmu1aJEVrhn457hq8Mv3Q');
    curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "POST");
    curl_setopt($ch, CURLOPT_POSTFIELDS, $data_string);
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
    curl_setopt($ch, CURLOPT_HTTPHEADER, array(
        'Content-Type: application/json'
        //TODO Add gzip compression and handle decompression with gzinflate
